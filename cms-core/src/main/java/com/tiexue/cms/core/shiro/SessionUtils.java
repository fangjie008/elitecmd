...
import com.tiexue.cms.core.contants.SessionConstants;
...
//	}
	 ...
	 * @return user
	 */
	public static CmsAdmin getCurrentUser() {
		Session session = SecurityUtils.getSubject().getSession();
		if (null != session) {
			return (CmsAdmin) session.getAttribute(SessionConstants.SESSION_USER_KEY);
		} else {
			return null;
		}
	}
